...
import com.brandoo.service.AccountService;
...
public class AccountController implements CrudController<Account,java.lang.Integer>{
    ...
    @Override
    public ResponseEntity<Page<Account>> read(
    ...
    @Override
    public ResponseEntity<Account> readOne(@PathVariable("id") java.lang.Integer primaryKey) {
